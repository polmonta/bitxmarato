  ...
  return (
    <View style={styles.container}>
        <View style={styles.questionContainer}>
            <Text style={styles.questionText}>Ha patit ofegs en repòs?</Text>
        </View>
        ...
        <View style={styles.arrowsContainer}>
            <TouchableOpacity style={[styles.arrowContainer, {marginLeft: '5%' }]} onPress={() => navigation.navigate("Musculs")}>
